          ...
          child:Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text('Un problème ?',style: Theme.of(context).textTheme.headline,),
              ),
              RaisedButton(
                child: Text('Tentez à nouveau',style: Theme.of(context).textTheme.button.copyWith(color: Colors.white),),
                elevation: 0.0,
                onPressed:loadBlogs,
              )
            ],
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              elevation: 0.0,
              onPressed: () =>
                  html.window.open(Constants.PROFILE_LINKEDIN, 'Souvannarith Chea'),
            )
          ],
        ),
      ),
